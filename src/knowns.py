...
KNOWN_BRANDS = ['Ford', 'Volkswagen', 'Jeep', 'BAIC', 'Kia', 'Hyundai', 'Porsche',
                'Peugeot', 'Fiat', 'Chevrolet', 'Citroën', 'BMW', 'Audi', 'Honda',
                'Nissan', 'Mercedes-Benz', 'Renault', 'Suzuki', 'Toyota', 'Chery',
                'Daihatsu', 'SsangYong', 'Dodge', 'JAC', 'Land Rover', 'Alfa Romeo', 
                'Haval', 'Volvo', 'Lifan', 'Mini', 'D·S', 'Mitsubishi', 'Jetour',
                'GWM', 'KAIYI','Lexus', 'Isuzu', 'Subaru', 'Jaguar']
...
KNOWN_SELLERS = ['concesionaria', 'particular', 'tienda']

KNOWN_FUELS = ['nafta', 'gnc', 'diesel', 'electrico', 'hibrido']

KNOWN_TRANSMISSIONS = ['automática', 'manual']